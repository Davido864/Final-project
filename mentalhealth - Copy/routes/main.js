...
app.get('/wellbeingflashcard2', function(req, res) {
    res.render('wellbeingflashcard2.ejs');
});

app.get('/wellbeingflashcard3', function(req, res) {
    res.render('wellbeingflashcard3.ejs');
});

app.get('/wellbeingflashcard4', function(req, res) {
    res.render('wellbeingflashcard4.ejs');
});

app.get('/wellbeingflashcard5', function(req, res) {
    res.render('wellbeingflashcard5.ejs');
});

app.get('/flashcardwellbeing', function(req, res) {
    res.render('flashcardwellbeing.ejs');
});

app.get('/flashcardwellbeing2', function(req, res) {
    res.render('flashcardwellbeing2.ejs');
});

app.get('/flashcardwellbeing3', function(req, res) {
    res.render('flashcardwellbeing3.ejs');
});

app.get('/flashcardwellbeing4', function(req, res) {
    res.render('flashcardwellbeing4.ejs');
});

app.get('/flashcardwellbeing5', function(req, res) {
    res.render('flashcardwellbeing5.ejs');
});
...
app.get('/disabilityflashcard2', function(req, res) {
    res.render('disabilityflashcard2.ejs');
});

app.get('/disabilityflashcard3', function(req, res) {
    res.render('disabilityflashcard3.ejs');
});

app.get('/disabilityflashcard4', function(req, res) {
    res.render('disabilityflashcard4.ejs');
});

app.get('/disabilityflashcard5', function(req, res) {
    res.render('disabilityflashcard5.ejs');
});

app.get('/flashcarddisability', function(req, res) {
    res.render('flashcarddisability.ejs');
});

app.get('/flashcarddisability2', function(req, res) {
    res.render('flashcarddisability2.ejs');
});

app.get('/flashcarddisability3', function(req, res) {
    res.render('flashcarddisability3.ejs');
});

app.get('/flashcarddisability4', function(req, res) {
    res.render('flashcarddisability4.ejs');
});

app.get('/flashcarddisability5', function(req, res) {
    res.render('flashcarddisability5.ejs');
});
...
app.get('/bullyingflashcard2', function(req, res) {
    res.render('bullyingflashcard2.ejs');
});

app.get('/bullyingflashcard3', function(req, res) {
    res.render('bullyingflashcard3.ejs');
});

app.get('/bullyingflashcard4', function(req, res) {
    res.render('bullyingflashcard4.ejs');
});

app.get('/bullyingflashcard5', function(req, res) {
    res.render('bullyingflashcard5.ejs');
});

app.get('/flashcardbullying', function(req, res) {
    res.render('flashcardbullying.ejs');
});

app.get('/flashcardbullying2', function(req, res) {
    res.render('flashcardbullying2.ejs');
});

app.get('/flashcardbullying3', function(req, res) {
    res.render('flashcardbullying3.ejs');
});

app.get('/flashcardbullying4', function(req, res) {
    res.render('flashcardbullying4.ejs');
});

app.get('/flashcardbullying5', function(req, res) {
    res.render('flashcardbullying5.ejs');
});
